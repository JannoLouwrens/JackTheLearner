...
> the Review has missed its schedule: newest row in docs/PROGRESS_LOG.md is 2026-09-16 (2d old; the schedule allows 1d)
...
> Stamped 2026-09-18T12:37:03+00:00 by scripts/lib_seal.sh. It disappears the next time the
