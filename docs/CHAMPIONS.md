...
| Episodic retrieval | lexical containment | BY VERDICT (ME.1/ME.9) — **known weakness: 0.000 on paraphrase** | ME.11.A–F (registered; B/C/D settled FAIL 2026-08-31) | **measured, not predicted (cell corrected per 55th audit B3 — "potion-8M favourite" was falsified by `e3824bf`):** bm25s 0.000 (a PROVEN lexical ceiling), potion-8M 0.0437, MiniLM 0.0667 — every dense configuration INFEASIBLE (tau_fpr > tau_cov, 3/3 seeds), best unthresholded ceiling 0.250 vs the 0.80 bar; the cascade's premise is dead too (Arm C recall@50 measured 0.44, not the pilot's 1.0 — probe 2026-08-31). No challenger currently threatens the seat; family disposition routed as `me11-every-arm-hits-the-same-infeasible-branch` |
