...
|---|---|---|---|---|
| Learning core | PPO (tuned per Moon et al. — F9) | **DEFAULT, never defended** | LC.00–LC.06 (LC.00–LC.02 + PS.01 PASS; **LC.03 VOIDed a SECOND time 2026-08-21 02:11 after a 15.8 h re-run — "fewer than two learners", zero arms at 3σ, best `wm-efe` +74.5 s at t=1.25 against 150–220 s spreads — and the data-starved guard fired (4/5 slopes positive), so a 4× envelope re-screen (v2) was launched 04:24 and is IN FLIGHT, pid 310395 + 3 workers, ETA ~Aug 23 late.** Cell refreshed by the Review 2026-08-21) | DreamerV3-class + others — screening only: LC.03 declares no winner; the seat's actual match is LC.04, still ahead. **SEAT STILL FLAGGED STALE (rule 4, Review 2026-08-20, unchanged 08-21): the default champion has never been contested. The flag now has a scheduled resolution for the first time — v2 either clears two learners or the screening design itself is the finding.** |
