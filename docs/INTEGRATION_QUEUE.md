...
| CURIOSITY_BAKEOFF.md | LT.01–LT.09 | PENDING — the other half of OVERSIGHT B5 (LT.03/LT.04 are the `Curiosity signal` seat's phantom arena, still 1 of the 5 UNFALSIFIABLE seats). Next entry down. |
