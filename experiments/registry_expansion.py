...
EXPANSION: list[Spec] = [
    ...
    Spec("T0.31", 0, "The backlog reader cannot be quieted by tidying the backlog",
         hypothesis="`experiments/review_queue.py` — the reader "
                    ...
                    "(7) an absent git baseline accuses nobody.",
         falsified_by="Any property failing; the battery running fewer than "
                      ...
                      "class in `VIOLATIONS` that no document can trigger, or "
                      "a finding the report does not print.",
         ...
         control="See null_baseline. Named properties "
                 ...
                 "p5_deleting_the_row_does_not_help and "
                 "p11_every_class_is_reachable_and_reported must be among the "
         ...
         notes="SCAR (52nd audit, 2026-08-31, B4). The Review's Sunday FULL "
               ...
               "good — `ACTED` is the Review's word about its own work and "
               "this module takes it. And `MAX_OPEN_AGE_DAYS = 8` is DERIVED "
