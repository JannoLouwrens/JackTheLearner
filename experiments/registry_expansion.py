...
EXPANSION: list[Spec] = [
    ...
    Spec("NE.01", 2, "The needs are a real control problem: nobody survives by accident",
         ...
         notes="COVERS: hunger/thirst (fixture)\n"
               ...
               "modelling assumption. REGISTRATION GATE 2026-08-24, carried from "
               "NEEDS_AND_DEATH §9 per the queue caveat: the §1.2 biology "
               "citations are UNVERIFIED, and two of them are design constants — "
               "the thermal lethal bounds (28C/40C, asymmetric) and the Borbély "
               "time-constant ratio (~4.4:1) setting tau_wake/tau_sleep. NE.01 "
               "MUST NOT fix those constants until a citation pass closes §1.2. "
